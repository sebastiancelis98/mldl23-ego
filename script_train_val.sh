...
then
	...
	#------ main command ------#
	python ta3n_training_script.py $class_file $modality $train_source_list $train_target_list $val_list --exp_path $exp_path \
	...
	-b $bS $bS $bS -j 4 -ef 1 -pf 50 -sf 50 --copy_list N N --save_model \
